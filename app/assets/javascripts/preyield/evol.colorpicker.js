...
var _idx=0,
	...
	// history=[],
	baseThemeColors=['ff0000','00CC00','F37233','714342','FFC512','800080','F284B4','FFE5B4','603','008080','00FFFF','1f497d','4f81bd','c0504d','f79646','cc99ff'],
	...
	standardColors=['c00000','ff0000','ffc000','ffff00','92d050','00b050','00b0f0','0070c0','002060','7030a0','3399ff','eeece1','1f497d','4f81bd','c0504d','9bbb59','8064a2','4bacc6','f79646','cc99ff'],
	// webColors=[
...
$.widget( "evol.colorpicker", {
		...
		switch(this.element.get(0).tagName){
			case 'INPUT':
				var color=this.options.color,
					e=this.element,
					css=((this.options.showOn==='focus')?'':'evo-pointer ')+'evo-colorin'+(isMoz?'-ff':_ie)+(this.options.hideButton?' evo-hidden-button':''),
					style='display:none;';
				this._isPopup=true;
				this._palette=null;
				if(color!==null){
				...
				e.addClass('colorPicker '+this._id)
					.wrap('<div style="width:'+(this.options.hideButton?this.element.width():this.element.width()+00)+'%;'+
	...
	_paletteHTML1: function() {
		...
		// base theme colors
		var h='<table class="evo-palette'+_ie+'" style="">'+oTRTH+labels[0]+'</th></tr><tr>';
		for(var i=0;i<20;i++){ 
...
// $('.colorPicker').attr('style', 'color:' +c);
// $('.colorPicker').attr('style', 'background-color:' +c);
document.getElementById("learning_group_color").style.color=c
document.getElementById("learning_group_color").style.backgroundColor=c

$('.lg').attr('style','background-color:'+c);
